...
import com.parse.starter.zubbycab.view.registration_login.presenter.HasPasswordPresenter;
            ...
            case R.id.fab:
                if (isOtp) {
                    ...
                    if (mActivityAddMobileNumberBinding.contentaddmobilenumber.enterphone.getText().toString().trim().equals("")
                            ...
                            toString().trim())) {
                        Toast.makeText(context, getResources().getString(R.string.warning_add_phone), Toast.LENGTH_LONG).show();
                    } else {
                        addData();
                    }
                }
